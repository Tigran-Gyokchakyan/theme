...
get_header(); ?>
    ...
    <main class="main" style="padding-top: 70px;">
        <section class="review mobile rubasshki" style="background-image:url(/wp-content/uploads/2021/01/MyCollages.jpg);">
            <div class="container">
                <div class="review__inner">
                    <h1 class="review__title">РУБАШКИ</h1>
                </div>
            </div>
        ...
        <section class="items1" id="items1">
            <div class="container">
				...
				<?php
				echo do_shortcode('[product_category orderby="menu_order" order="asc" category="cat_rubashki"]');
				?>
                <!--</div>-->
            </div>
        </section>
        ...
        <section class="items3" id="items1" style="padding-top: 0;">
            <div class="container">
				<?php
				echo do_shortcode('[product_category orderby="menu_order" order="asc" category="cat_rubashki_2"]');
				?>
            </div>
        </section>
        ...
        <section class="items1" id="items1">
            <div class="container">
                <!--<div class="items1__inner">-->
				<?php
				echo do_shortcode('[product_category orderby="menu_order" order="asc" category="cat_rubashki_3"]');
				?>
                <!--</div>-->
            </div>
        </section>
