                            ...
                            <div class="container">
                                <div class="preview__slider-item-inner">
                                    <div class="preview__slider-item-text" data-aos="fade-up">
                                        <div class="preview__slider-item-text-top"> Для Поваров, Барменов, Официантов и др. </div>
            ...
            <div class="container">
                <div class="apron__inner">
                    <div class="apron__text-block" data-aos="fade-up">
                        ...
                        <h2 class="apron__title">Фартуки</h2>
                        <a href="fartuki/" class="apron__button link-btn">перейти</a>
                    </div>
                </div>
            </div>
        </section>
        <section class="tunic" id="2">
            <div class="container">
                <div class="tunic__inner" data-aos="fade-up">
                    <h2 class="tunic__title">Кители</h2>
                    <div class="tunic__text">Не такие как все</div>
                    <a href="kiteli/" class="tunic__button link-btn">перейти</a>
                </div>
            </div>
        </section>
        <section class="pants">
            <div class="container">
                <div class="pants__inner" data-aos="fade-up">
                    ...
                    <a href="bryuki-yubki/" class="pants__button link-btn">перейти</a>
                </div>
            </div>
        </section>
        <section class="shirts" style="background-image:url(/wp-content/themes/zapara/assets/dist/bg4.35567f94.jpg);">
            <div class="container">
                <div class="shirts__inner" data-aos="fade-up">
                    ...
                    <h2 class="shirts__title">Рубашки & Топы</h2>
                    <a href="rubashki/" class="shirts__button link-btn">перейти</a>
                </div>
            </div>
        </section>
        <section class="accessories" id="3">
            <div class="container">
                <div class="accessories__inner" data-aos="fade-up">
                    <div class="accessories__subtitle"> Дополняй, улучшай, обновляй </div>
                    <h2 class="accessories__title">Аксессуары</h2>
                    <a href="accessories/" class="accessories__button link-btn">перейти</a>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="uniform__inner">
                    ...
                    <div class="uniform__text" data-aos="fade-up">
                        ...
                        <a href="#1" class="uniform__link">в каталог</a>
                    </div>
                </div>
            </div>
        </section>
        <section class="clients">
            <div class="container">
                <div class="clients__wrapper">
					...
					<div class="clients__grid"><div class="clients__grid-item">
<img src="/wp-content/themes/zapara/assets/images/clients/15a.jpg" alt=""></div><div class="clients__grid-item">
<img src="/wp-content/themes/zapara/assets/images/clients/image-2.png" alt=""></div><div class="clients__grid-item">
<img src="/wp-content/themes/zapara/assets/images/clients/image-3.jpg" alt=""></div><div class="clients__grid-item">
<img src="/wp-content/themes/zapara/assets/images/clients/image-4.jpg" alt=""></div><div class="clients__grid-item">
<img src="/wp-content/themes/zapara/assets/images/clients/image-5.jpg" alt=""></div><div class="clients__grid-item">
<img src="/wp-content/themes/zapara/assets/images/clients/image-6.jpg" alt=""></div><div class="clients__grid-item">
<img src="/wp-content/themes/zapara/assets/images/clients/image-7.png" alt=""></div><div class="clients__grid-item">
<img src="/wp-content/themes/zapara/assets/images/clients/image-8.png" alt=""></div><div class="clients__grid-item">
<img src="/wp-content/themes/zapara/assets/images/clients/image-9.jpg" alt=""></div><div class="clients__grid-item">
<img src="/wp-content/themes/zapara/assets/images/clients/image-10.png" alt=""></div></div>
					
					
					
					
                   <!-- <div class="clients__grid">
                        <?php for($client=1;$client<=10;$client++) { ?>
                            <div class="clients__grid-item">
                                <img src="/wp-content/themes/zapara/assets/images/clients/image-<?= $client ?>.jpg" alt="">
                            </div>
                        <?php } ?>
                    </div>-->
                </div>
            ...
            <div class="container">
                <div class="review__wrapper">
                    <div class="review__wrapper-header">
                        <h2 class="review__wrapper-header-title" data-aos="fade-up"> Вот что говорят </h2>
                        <p class="review__wrapper-header-text" data-aos="fade-up"> Те, кто уже знаком с нами: </p>
                    </div>
                            ...
                            <div class="swiper-wrapper review__slider-wrapper">
                                <div class="review__slider-wrapper-slide swiper-slide">
                                    <div class="review__slide-header">
                                        <img src="/wp-content/themes/zapara/assets/images/reviews/review-1.jpg" alt="" class="review__slide-header-image">
                                        <div class="review__slide-header-info">
                                            <h3>Ольга Маримон</h3>
                                            <p>Aviator, Кемерово</p>
                                            <div class="review__slide-stars">
                                                <svg xmlns:xlink="http://www.w3.org/1999/xlink" class="review__slide-stars-star">
                                    ...
                                    <p class="review__slide-content">Спасибо большое вашей команде! Определенно, показали высокий профессионализм! <br>Мы остались довольны! Работать с вами было комфортно - вопросы решались оперативно, <br>цвет фартука "в точку"! Все быстро и качественно! <br>Несомненно, для последующих заказов, обращусь именно к вам!!! <br>Спасибо!!!</p>
                                </div>
                                <div class="review__slider-wrapper-slide swiper-slide">
                                    <div class="review__slide-header">
                                    ...
                                    <p class="review__slide-content">Все не было времени Вам отписаться - фартуки просто "огонь"! Выше всяких похвал! Мы в восторге. Теперь Вы в нашей базе любимых подрядчиков)</p>
                                </div>
                                <div class="review__slider-wrapper-slide swiper-slide">
                                    <div class="review__slide-header">
                                    ...
                                    <p class="review__slide-content">Пишу с запозданием, но от этого не с меньшим восторгом. Мы всей нашей командой очень довольны качеством исполнения фартуков, они очень стойкие, устойчивы к частым стиркам, очень стильные. По сервису нареканий тоже нет, все супер. Спасибо вам и вашей команде за качественный продукт и за ответственный подход к работе.</p>
                                </div>
                            </div>
        ...
        <section class="gallery" id="4">
            <div class="container">
                <div class="gallery__wrapper">
                    <h2 class="gallery__wrapper-title" data-aos="fade-up"> Галерея выполненных работ </h2>
                    <div class="gallery__wrapper-content">
						<?php
						echo do_shortcode('[nggallery id="1"]');
						?>
                        <button class="link-btn gallery__open_dop"> еще... </button>
                        <div class="gallery__dop"><?php
