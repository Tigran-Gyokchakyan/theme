...
get_header(); ?>
      ...
      <main class="main" style="padding-top: 70px;">
         ...
         <section class="items3" id="items1">
            <div class="container">
            <?php 
               echo do_shortcode('[product_category orderby="menu_order" order="asc" category="cat_kiteli"]');
            ?>
            </div>
         </section>
         ...
         <section class="items1">
            <div class="container">
               ...
               <?php 
                    echo do_shortcode('[product_category orderby="menu_order" order="asc" category="cat_kiteli_2"]');
                ?>
               <!--</div>-->
            </div>
         </section>

         <section class="items3" id="items1" style="padding-top: 0;">
            <div class="container">
            <?php 
               echo do_shortcode('[product_category orderby="menu_order" order="asc" category="cat_kiteli_3"]');
            ?>
            </div>
         </section>
         ...
         <section class="items1">
            <div class="container">
               <!--<div class="items1__inner">-->
               <?php 
                    echo do_shortcode('[product_category orderby="menu_order" order="asc" category="cat_kiteli_4"]');
                ?>
               <!--</div>-->
            </div>
         </section>

         <section class="items___1 kiteli">
            <div class="container">
               <!--<div class="items1__inner">-->
               <?php 
                    echo do_shortcode('[product_category orderby="date" order="desc" category="cat_kiteli_5"]');
                ?>
               <!--</div>-->
            </div>
         </section>
         ...
         <section class="items1">
            <div class="container">
               <!--<div class="items1__inner">-->
               <?php 
                    echo do_shortcode('[product_category orderby="menu_order" order="asc" category="cat_kiteli_6"]');
                ?>
               <!--</div>-->
            </div>
         </section>
